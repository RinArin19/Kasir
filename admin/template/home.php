...
<div class="row">
    ...
    <div class="col-md-3 mb-3">
        <div class="card">
            <div class="card-header bg-primary text-white">
                <h6 class="pt-2"><i class="fa fa-upload" aria-hidden="true"></i> Daftar Barang</h6>
            </div>
            <div class="card-body">
                <center>
            ...
            <div class="card-footer">
                <a href='index.php?page=barang'>List
    ...
    <div class="col-md-3 mb-3">
        <div class="card">
            <div class="card-header bg-primary text-white">
                <h6 class="pt-2"><i class="fas fa-clipboard"></i> Stok Barang</h6>
            </div>
            <div class="card-body">
                <center>
    ...
    <div class="col-md-3 mb-3">
        <div class="card">
            <div class="card-header bg-primary text-white">
                <h6 class="pt-2"><i class="fas fa-chart-bar"></i> Laporan Penjualan</h6>
            </div>
            <div class="card-body">
                <center>
    ...
    <div class="col-md-3 mb-3">
        <div class="card">
            <div class="card-header bg-primary text-white">
                <h6 class="pt-2"><i class="fa fa-tags"></i> Kategori Barang</h6>
            </div>
            <div class="card-body">
                <center>
            ...
            <div class="card-footer">
                <a href='index.php?page=kategori'>List
